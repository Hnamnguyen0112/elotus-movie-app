...
export const ELOTUS_MOVIE_TITLE_PREFIX = 'Elotus Movie - ';
export const ELOTUS_MOVIE_ACCESS_TOKEN = 'elotus_movie/app/ACCESS_TOKEN';
export const ELOTUS_MOVIE_REFRESH_TOKEN = 'elotus_movie/app/REFRESH_TOKEN';
